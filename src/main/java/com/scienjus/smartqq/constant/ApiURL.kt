 ...
 * @date 2015/12/19
 */
enum class ApiURL(val url: String, val referer: String?) {
    ...
    companion object {
        val USER_AGENT = "Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36"
    }
}
